...
| `/crew investigate` Step 2 | create | Building | `spike` | `investigate.md` Step 2 |
| `/crew investigate` Step 6 (after recommendation) | update-status | Shipped (consumed) / Building (continue) | — | `investigate.md` Step 6 |
